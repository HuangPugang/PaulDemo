package demo.hpg.org.pauldemo.slidingfinish;
...
public class ViewPagerActivity extends SwipeBackActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_sliding_viewpager);
		
		viewPager = (ViewPager) findViewById(R.id.frame_main_viewpage);
		
		for(int i=0; i<5; i++){
			View v = LayoutInflater.from(this).inflate(R.layout.activity_sliding_normal, null);
			list.add(v);
		}
